...
namespace UnityCNTK.LayerDefinitions
{
    public static class LayerDefineHelper
    {
        ...
        public static LayerDense[] DenseLayers(int numOfLayers, int hiddenSize, NormalizationMethod normalizatoin = NormalizationMethod.None, float dropout = 0.0f, float initialWeightScale = 0.1f, ActivationFunction activation = ActivationFunction.Relu)
        {
